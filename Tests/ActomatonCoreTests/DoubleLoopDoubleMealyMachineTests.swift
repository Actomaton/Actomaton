...
/// Double-loop implemented with **two nested** `MealyMachine` instances using the built-in
/// synchronous feedback loop. See ``makeOuterMachine(m:)`` for the corresponding `MealyMachine`
/// construction.
